...
# Task 1: The UI Shell
st.title("The identity of echo interface")
...
if st.button("Transmit"):
    ...
    st.info(f"System Check: Your message contains {char_count} characters & will consume approximately {token_count} tokens from our context window.")